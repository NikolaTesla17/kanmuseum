...
components.fontMontserrat = {
	selector: 'html',
	styles: 'https://fonts.googleapis.com/css2?family=Montserrat:ital,wght@0,400;0,500;0,700;1,400&family=Gaegu:wght@700&display=swap'
};
...
components.bootstrapDateTimePicker = {
	selector: '[data-time-picker]',
	styles: './components/bootstrap-material-datetimepicker/bootstrap-material-datetimepicker.css',
	script: [
		'./components/jquery/jquery.min.js',
		'./components/moment-js/moment-js.min.js',
		'./components/bootstrap-material-datetimepicker/bootstrap-material-datetimepicker.min.js'
	],
	init: function ( nodes ) {
		nodes.forEach( function ( node ) {
			var $dateTimePicker = $( node );
			var options = {};
...
components.particles = {
	...
	init: function ( nodes ) {
		nodes.forEach( function ( node ) {
			console.log( node.getAttribute( 'data-particles-json' ) );
			let options = node.getAttribute( 'data-particles-json' ) || {};
			particlesJS.load( node.id, options );
		});
	}
};
